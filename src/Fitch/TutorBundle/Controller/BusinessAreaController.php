...
class BusinessAreaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            $businessAreaManager->saveBusinessArea($businessArea);
...
//    {
//        $out = [];
//        foreach ($this->getBusinessAreaManager()->findAll() as $businessArea) {
//            $out[] = [
//                'value' => $businessArea->getId(),
//                'text' => $businessArea->getName(),
//            ];
//        }
//
